...
rects2 = ax1.bar(ind + width/2, r1_average, width, yerr = r1_conf, capsize = 3, color = 'gray', edgecolor = 'k',
                label = 'Recall')
...
rects4 = ax2.bar(ind + width/2, r2_average, width, yerr = r2_conf, capsize = 3, color = 'gray', edgecolor = 'k',
                label = 'Recall')
...
rects6 = ax3.bar(ind + width/2, r3_average, width, yerr = r3_conf, capsize = 3, color = 'gray', edgecolor = 'k',
                label = 'Recall')
...
rects7 = ax4.bar(ind - width/2, j4_average, width, yerr = j4_conf, capsize = 3, color = 'w', edgecolor = 'k',
                label ='JOL')

rects8 = ax4.bar(ind + width/2, r4_average, width, yerr = r4_conf, capsize = 3, color = 'gray', edgecolor = 'k',
                label = 'Recall')
